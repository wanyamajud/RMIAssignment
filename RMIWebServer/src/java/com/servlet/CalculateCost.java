 ...
 * @author admin
 */
@WebServlet(name = "CalculateCost", urlPatterns = {"/CalculateCost"})
public class CalculateCost extends HttpServlet {
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
               ...
               // JSONObject obj = new JSONObject(recievedRequest.toString());
                ...
                respMsg.put("code", "0");
                String r = service.fetch();                
                respMsg.put("receipt", r);
    ...
    public static void main(String[] args) {
        String b = "billyBR100ENbillyBR100ENbillyBR100ENmatundaBR90ENmmmmmmBR100ENmmnnnnnBR111111EN";
        
        String c = b.substring(0,b.length()-2);
        
         for (String e : c.split("EN")){
             String n = e.split("BR")[0];
                     String p = e.split("BR")[1];
